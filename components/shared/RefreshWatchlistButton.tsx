...
export default function RefreshWatchlistButton() {
  ...
  return (
    <button
      ...
      disabled={isPending}
      className="flex items-center gap-2 px-4 py-2 rounded-xl bg-gray-800 border border-gray-800 text-sm font-medium text-gray-300 hover:text-white hover:bg-gray-700 transition-all disabled:opacity-50"
    >
      <RefreshCw
        size={16}
        className={cn(
